#!/usr/bin/env python3
"""
Schematic of the four dispersion-relation types (Shaberi 2025 + Diego 2018
'filter'), one row of four panels. All have a stable homogeneous state at k=0.
Colours match the classifier.
"""
...
COLORS = {'Type I': 'steelblue', 'Type II': 'mediumvioletred',
          'Hopf': 'darkorange', 'Filter': 'seagreen'}
TYPES = [('Type I', reI, None), ('Type II', reII, None),
         ('Hopf', reH, imH), ('Filter', reF, None)]
...
for ax, (name, re, im) in zip(axes, TYPES):
    ...
    ax.set_title(name, fontsize=14, loc='left', fontweight='bold', color=c)
    ax.set_ylim(-0.6, 0.75); ax.set_xlim(0, 6)
