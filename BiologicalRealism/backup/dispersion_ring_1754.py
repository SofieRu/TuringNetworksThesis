...
from heterogenous_ring_1754 import compute_jacobian, find_steady_state, build_ring_jacobian_heterogeneous
...
#         # Plot Baseline
#         ax.plot(K_DISCRETE, baseline_disp, 'o-', color='black', linewidth=2.0, 
...
# plt.savefig('1754_homogeneous_dispersion_comparison.png', dpi=200, bbox_inches='tight')
# print("\nSaved: 1754_homogeneous_dispersion_comparison.png")
# plt.close()
...
fig_multi.subplots_adjust(left=0.09, right=0.96, top=0.85, bottom=0.18, wspace=0.04, hspace=0.06)
fig_multi.suptitle(
    f'Topology 1754 Heterogeneous Ring Dispersion Comparison (N={N_RING} cells)\n'
    f'Rows track Config {CONFIG_IDS[0]} vs Config {CONFIG_IDS[1]}',
    fontsize=14, y=0.95
)
...
plt.savefig('1754_heterogeneous_dispersion_comparison.png', dpi=200, bbox_inches='tight')
print("Saved as 1754_heterogeneous_dispersion_comparison.png")
plt.close()