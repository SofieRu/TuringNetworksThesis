...
from BiologicalRealism.heterogenous_ring_3954_OG import compute_jacobian, find_steady_state
...
### figure 1: code for one plot for on config id in 3954 ###
...
title_multi = fig_multi.suptitle(
    f'Dispersion Relations Under Parameter Heterogeneity\nTopology #3954 with {N_TRIALS} Noise Realisations per CV',
...
fig_multi.subplots_adjust(left=0.09, right=0.96, top=0.86, bottom=0.11, wspace=0.12, hspace=0.08)
