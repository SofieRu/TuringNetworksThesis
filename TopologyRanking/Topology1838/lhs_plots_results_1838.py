...
#     ax.set_title(
#         "Robustness Scores by Turing Type for #1823\n(Latin Hypercube Sampling, 1 million simulations)",
#         fontsize=12, loc="left", pad=10,
#     )
#     ax.xaxis.grid(False)
#     ax.set_xlim(-0.5, 2.5)
...
def fig2_dotplot(df):
    ...
    ax.set_ylabel("Robustness Score (in %, Shaberi Method)", fontsize=11)
    ax.set_title(
        "Robustness Scores by Turing Type for #1838\n(Latin Hypercube Sampling, 1 million simulations)",
        fontsize=12, loc="left", pad=10,
    )
    ax.xaxis.grid(False)
    ax.set_xlim(-0.5, 2.5)
...
#     ax.set_title(
#         "Robustness Scores Diego vs Shaberi for #1838\n(Latin Hypercube Sampling, 1 million simulations)",
#         fontsize=12, loc="left", pad=10,
#     )
...
#     fig.tight_layout()
#     save(fig, "1838_lhs_fig4_diego_vs_shaberi")
