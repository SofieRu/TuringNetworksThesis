...
def fig_combined_overview_and_raincloud(df):
    ...
    fig, (ax1, ax2) = plt.subplots(2, 1, figsize=(12.4,6.4))
    ...
    ax1.set_title("Latin Hypercube Sampling Results, $10^6$ simulations\nRobustness of different diffusion rate configurations for Topology #1838",fontsize=16,loc="center",pad=10,)
    ...
    ax2.set_title("Robustness distribution by Type for Topology #1838",fontsize=16,loc="center",pad=10,)
