...
result_files = sorted(glob.glob('results/NEW_LHS_1838_*_1mio.pkl'))
...
df.to_csv('1838_PREFINAL_lhs_results_summary.csv', index=False)
print("\nSaved to: 1838_PREFINAL_lhs_results_summary.csv")