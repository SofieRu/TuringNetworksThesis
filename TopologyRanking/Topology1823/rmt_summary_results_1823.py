...
# Find all RMT pickle files (only RMT_1823 files, 100k samples)
result_files = sorted(glob.glob('results/NEW_RMT_1823_*_1mio.pkl'))
...
print("TOPOLOGY #1823 RMT TURING PATTERN ROBUSTNESS SUMMARY")
print("="*140)
print(df[cols_display].to_string(index=False))

output_file = '1823_FINAL_rmt_results_summary.csv'
