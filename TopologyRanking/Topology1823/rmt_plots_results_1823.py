...
def fig1_sigma_vs_robustness(df):
    ...
    ax_stable.set_title(
        "Topology #1823 RMT Sigma vs Robustness and Stability",
    ...
    fig.tight_layout()
    save(fig, "1823_rmt_fig1_sigma_vs_robustness_all")
...
def fig2_corrected_robustness(df):
    ...
    ax_stable.set_title(
        "Topology #1823 RMT Corrected robustness vs σ",
        fontsize=12, loc="left", pad=10,
    )
    ...
    fig.tight_layout()
    save(fig, "1823_rmt_fig2_corrected_robustness")
...
def fig3_corrected_overview(df):
    ...
    ax_stable.set_title(
        "Topology #1823 RMT Sigma vs Corrected Robustness overview (all configurations)",
        fontsize=12, loc="left", pad=10,
    )
    ...
    fig.tight_layout()
    save(fig, "1823_rmt_fig3_corrected_overview")
...
def fig4_dotplot_fixed_sigma(df, sigma_val=1.0):
    ...
    ax.set_title(
        f"Topology #1823 RMT – Robustness by Turing Type at σ = {sigma_val}",
        fontsize=12, loc="left", pad=10,
    )
    ax.xaxis.grid(False)
    ax.set_xlim(-0.5, 2.5)
    ...
    fig.tight_layout()
    save(fig, f"1823_rmt_fig4_dotplot_sigma{sigma_val}")
...
#     ax.set_title(
#         f"Topology #1823 RMT Max robustness per topology and Turing Type at σ = {sigma_val}",
#         fontsize=12, loc="left", pad=10,
#     )
#     ax.xaxis.grid(False)
...
#     fig.tight_layout()
#     save(fig, f"1823_rmt_fig5_grouped_topology_sigma{sigma_val}")
...
#fig5_grouped_topology(df, sigma_val=2.0)