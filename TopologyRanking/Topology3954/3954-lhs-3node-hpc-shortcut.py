...
# SHORTCUT VERSION, CHANGED SPACING OF K VALUES FROM 0.01 TO 0.1 (100 K VALUES INSTEAD OF 1000) in SHABERI AND DIEGO 
...
# TURING DETECTION METHODS CHANGED: for k in np.arange(0.01, 10.01, 0.01): previous 0.01 
